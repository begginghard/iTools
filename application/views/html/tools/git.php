            ...
            <div class="dropdown">
                ...
                <div class="widget related">
                    ...
                    <div class="bd">
                        ...
                        <?php
                            $m = isset($_GET['m']) ? trim($_GET['m']): 'init';
                            if(!empty($data)){
                        ...
                        <li class="<?php if($type!==null && $key == $type ){echo "open";}else{echo "";}?>">
                            ...
                            <?php
                                ...
                                if(!empty($val)){
                                    foreach($val as $k=>$v){
                            ?>
                                <li class="<?php if($v['name']== $m ){echo "now_command";}else{echo "";}?>"><a href="<?php echo base_url();?>GitCommand/index.html?m=<?php echo $v['name'];?>" title="cd"><?php echo $v['name'];?></a></li>
